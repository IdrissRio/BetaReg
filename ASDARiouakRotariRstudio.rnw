...
%plot(I(food/income) ~ income, data = FoodExpenditure, xlab = "income", 
%     ylab = "food/income", main = "Spese per alimenti", type = "n", ylim = c(0.04, 0.57))
%points(I(food/income) ~ income, data = FoodExpenditure, cex = 1.75, pch = 19, col =(c%("indianred4","lightpink2","indianred","lightpink3","lightpink1","lavenderblush1","floralwhite"))[persons])
%points(I(food/income) ~ income, data = FoodExpenditure, cex = 1.75)
%legend("topright", rev(as.character(sort(unique(FoodExpenditure$persons)))), title = "persons", col =(c("indianred4","lightpink2","indianred","lightpink3","lightpink1","lavenderblush1","floralwhite")), pch = 19, bty = "n")
%legend("topright", rev(as.character(sort(unique(FoodExpenditure$persons)))), title = "persons", pch = 1, bty = "n")
%@
